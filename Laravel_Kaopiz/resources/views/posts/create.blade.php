        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form role="form" method="post" action="storePost" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Title bài đăng</label>
                                <input type="text" name="title" class="form-control" id="" placeholder="Điền title">
                            </div>
                        ...
                        <div class="card-footer">
                            <a href="{{route('blog.index')}}" class="btn btn-default">Huỷ bỏ</a>
